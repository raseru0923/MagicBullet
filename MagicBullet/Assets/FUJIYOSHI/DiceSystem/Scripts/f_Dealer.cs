...
public class f_Dealer : MonoBehaviour
{
    // ダイスの設計図
    ...
    private async UniTask<f_Dice> CreateDice(int diceValue, CancellationToken ct = default)
    {
        // 設計図を使用し、ダイスを生成
        ...
        var dice = Dice.GetComponent<f_Dice>();
