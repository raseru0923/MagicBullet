...
public class FullButton : MonoBehaviour,
    ...
    IPointerUpHandler
{
    ...
    private void Call()
    {
        CallButton.Instance.CallObj = this.gameObject;
    }
    ...
    [SerializeField] private Useful LongTap = new Useful(true);
    [SerializeField] private Useful LongTapPrintGauge = new Useful(true);
    [SerializeField] private Useful TapDownWithZoomOut = new Useful(true);
    [SerializeField] private float ZoomOutTime = 0.125f;
    [SerializeField] private Useful TapDownWithGray = new Useful(true);
